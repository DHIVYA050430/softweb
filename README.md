        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-image: linear-gradient(rgba(0,0,0,0.75),rgba(0,0,0,0.75)),url(bcgimage.jpg);
...
<body>
    ...
    <footer>
        <center> Designed and Developed by DIVYA E (212223230050) </center>
    </footer>
</body>
</html>
        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-image: linear-gradient(rgba(227, 147, 194, 0),rgba(150, 232, 203, 0)),url(bcgimage2.jpg);
                background-size: cover;
                background-position: center;
            }
            .navbar {
        ...
        <div class="image">
            <table cellspacing="20"> 
                <tr align="center">
                    ...
                    <td> <img src="dhruv.jpeg"> </td>
                    <td> <img src="vijay.jpeg"> </td>
                    <td> <img src="ram.jpeg"> </td>
                    <td> <img src="anand.jpeg"> </td>
                    <td> <img src="dulquer.jpeg"> </td>
                </tr>
                <tr align="center">
                    <th> Divya </th>
                    <th> Dhruv Vikram </th>
                    ...
                    <th> Ram Charan </th>
                    <th> Anand Dvarkonda</th>
                    <th> Dulquer Salman </th>
                </tr>
                <tr align="center">
                    <td> CEO </td>
        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-image: linear-gradient(rgba(0,0,0,0.75),rgba(0,0,0,0.75)),url(bcg.jpeg);
                background-size: cover;
                background-position: center;
            }
            .navbar {
    ...
    <div class="banner">
        ...
        <div class="box">
            ...
            <div class="box-2"> 
                ...
                <p> <span>Email</span> : divya@gmail.com</p>
                <p> <span>Phone</span> : 8546154487 </p>
            </div>
        </div>
    </div>
    <footer>
...
## OUTPUT:
![alt text](<Screenshot 2024-05-05 234606.png>)
![alt text](<Screenshot 2024-05-05 234548.png>)
![alt text](<Screenshot 2024-05-05 234629.png>)
![alt text](<Screenshot 2024-05-05 234644.png>)
